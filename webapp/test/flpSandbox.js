					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Aplicativo Final VKT",
									"targetURL": "#zappvkt-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"zappvkt-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zappvkt",
									"url": sap.ui.require.toUrl("zappvkt")
								}
							}
						}
					}
